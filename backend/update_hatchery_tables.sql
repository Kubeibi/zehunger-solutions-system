...
-- Drop old hatchery tables if they exist
DROP TABLE IF EXISTS hatchery_batches;
DROP TABLE IF EXISTS hatchery_feeding;
DROP TABLE IF EXISTS hatchery_monitoring;
DROP TABLE IF EXISTS hatchery_cleaning;
DROP TABLE IF EXISTS hatchery_problems;
