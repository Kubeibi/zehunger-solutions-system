...
-- Drop old waste management tables if they exist
DROP TABLE IF EXISTS waste_storage;
DROP TABLE IF EXISTS waste_collections;
DROP TABLE IF EXISTS waste_sources;
DROP TABLE IF EXISTS storage_units;

-- Drop old versions of new tables if they exist
DROP TABLE IF EXISTS waste_sourcing;
...
-- Create new waste management tables
